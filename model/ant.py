...
class Ant:
    ...
    @staticmethod
    def calculate_total_travel_distance(graph, travel_path):
        distance = 0
    ...
    def insert_into_path(self, node_id, stop_event):
    ...
    def insert(self, stop_event):
        ...
        while success_to_insert:
            ...
            for node_id in ind_to_visit:
                ...
                best_insert_index = self.insert_into_path(node_id, stop_event)
    ...
    @staticmethod
    def local_search_once(graph, travel_path, travel_distance, i_start, stop_event):
    ...
    def local_search_procedure(self, stop_event):
